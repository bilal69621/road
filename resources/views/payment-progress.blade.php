...
$(document).ready(function(){
    ...
    // var form = localStorage.getItem('job_form');
    //
    // if (localStorage.getItem("job_form") === null) {
        postTheMessage();
        function postTheMessage() {
            window.parent.postMessage("iFrame sent a message", "https://driveroadside.com/*");
            window.parent.postMessage("iFrame sent a message", "https://www.driveroadside.com/*");
        }
    //     return false;
    // }
