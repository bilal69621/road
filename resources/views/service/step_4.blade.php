...
<main class="page-wrap parent-main">
    <section class="map-address sections-maps">
            ...
            <div class="modal-content">
                ...
                <form id="all_data">
                    ...
                    <div class="modal-steps-form modal_step_4">
                        ...
                        <div class="step-main-repeater">
                            <div class="step-form-title text-center " style="margin-bottom: 10px;">
...
{{--                                    <h6>Credit Card</h6>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control general-field card-field detechChange" size="16" pattern="/^-?\d+\.?\d*$/"
                                               onKeyPress="if (this.value.length == 16)
                                               return false;" data-stripe="number" id="cNumber" type="number"
                                               placeholder="4242 4242 4242 4242" name="cardnumber" required>
                                        <input type="hidden" name="choose_plan" id="choose_plan">
                                    </div>
                                    <div class="form-group">
                                        <label>Card Holder</label>
                                        <input type="text" class="form-control general-field " id="cName" name="name" id="card_name"
                                    ...
                                    <div class="cart-holder">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="exMonth" class="form-control general-field detechChange" id="cExpMonth"  required>
                                        ...
                                        <div class="form-group">
{{--                                            <input min="1" max="12" size="2" name="exMonth" id="cExpMonth" pattern="/^-?\d+\.?\d*$/" onKeyPress="if (this.value.length == 2)--}}
{{--                                                return false;" data-stripe="exp-month" type="number" class="form-control general-field detechChange"--}}
{{--                                                   placeholder="Month" required/>--}}
                                            <label>Exp.Year</label>
                                            <select name="exYear" class="form-control general-field detechChange" id="cExpYear"  required>
...
{{--                                            <input min="2020" size="2" name="exYear" id="cExpYear" pattern="/^-?\d+\.?\d*$/" onKeyPress="if (this.value.length == 2)--}}
{{--                                                return false;" data-stripe="exp-year" type="number" class="form-control general-field"--}}
{{--                                                   placeholder="Year" required/>--}}
                                        </div>
                                        <div class="form-group ">
                                            <label>CVC</label>
                                            <input size="3" pattern="/^-?\d+\.?\d*$/" id="cCvc" name="cvc" onKeyPress="if (this.value.length == 3)
                                                return false;" data-stripe="cvc" type="number"
                                                   class="form-control general-field detechChange" placeholder="CVC" required>
                                        </div>
                                        <div class="form-group ">
                                            <label>Address</label>
                                            <input  id="address_pay" name="address_pay"  type="text"
                                                    class="form-control general-field" placeholder="Billing Address" required>
					...
					<div class="form-group ">
                                            <input type="checkbox" name="terms" id="terms">  I Agree to the <a href="{{url('terms-of-use')}}" target="_blank"><b>Terms of Service</b></a> and <a href="{{route('privacy')}}" target="_blank"><b>Privacy Policy</b></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="credit-cart-save">
                                    <button id="strp-card-btn" type="button" class="btn btn_grey ">Get Help Now</button>
                                </div>
                                <img  class="mt-2" style="  width: 60%; margin: 0 auto;" src="<?=asset('public/assets/images/paypal1122.png')?>">
                                <a target="_blank" class="mt-2" href="https://driveroadside.com/terms-of-use" style="text-align: center; display: block;">Terms & Conditions</a>
                            ...
                            <div class="destinationPopUp"  style="border: #000000 1px solid">
                                ...
                                <p class="destinationLocation">{{$rlocations['vicinity']}}</p>
                                 ...
                                 <div class="reviewAndStar" >
                                    ...
                                    <input type="hidden" id="lng_{{$rlocations['place_id']}}" value="{{$rlocations['geometry']['location']['lng']}}">
   ...
   function tirenoavail()
   {
    ...
    <script>
        ...
        $('#address_pay').on('keypress',function (){
            ...
            autocomplete2 = new google.maps.places.Autocomplete(document.getElementById('address_pay'), options);
        ...
        function fillInAddress1() {
            ...
            var price = Math.round(139+(distance*5));
...
<script type="text/javascript">
    ...
    $('.modal_step_1_btn').click(function(){
        ...
        if ($("input[name=q1]:checked").val() == undefined ||$("input[name=q2]:checked").val() == undefined ||$("input[name=q3]:checked").val() == undefined ||$("input[name=q4]:checked").val() == undefined ||$("input[name=q5]:checked").val() == undefined){
            ...
            @elseif($type == 'tire')
            if ($("input[name=q1]:checked").val() == undefined ||$("input[name=q2]:checked").val() == undefined ||$("input[name=q3]:checked").val() == undefined ||$("input[name=q5]:checked").val() == undefined){
                errorShow();
                $(".st2").removeClass("active-tab-list");
            }else{
                $(".modal_step_1").removeClass("step-active");
...
//                data: {'price':$price},
    ...
    var infowindow = new google.maps.InfoWindow({
        content:'<div class="dispatch-tolltip" id="newdetailnote"><img src="{{asset("public/assets/images/close-manu.svg")}}" onclick="closedivnote()"><p id="statusMessage">We have located you here. Confirm the location on map is correct by clicking button below.</p></div> <a onclick="confirm_location()" id="hook">Click to Confirm</a>'});
...
{{--        @endif--}}
    ...
    $('.detechChange').on('change', function(){
        $('#strp-card-btn').prop('disabled', false);
    });

    $('#strp-card-btn').on('click',function(){
        if($('#address_pay').val().length == 0 || $('#address_pay').val() == ''){
            $('#preloader').hide();
            $('.payment-errors').html('Billing Address is required');
            $('#strp-card-btn').html('Get Help Now');
	    ...
	    if (!$('#terms').is(':checked')) {
            $('#preloader').hide();
            $('.payment-errors').html('Must agree to terms and policy');
            $('#strp-card-btn').html('Get Help Now');
            document.getElementById("strp-card-btn").style.background = '#2d81bc';
            $('#strp-card-btn').prop('disabled', false);
            return;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".credit-cart").animate({ scrollTop: 0 }, "slow");
