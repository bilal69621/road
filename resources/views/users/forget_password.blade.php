...
<head>
    ...
    <title>RoadSide | Forget Password</title>
        ...
        <div class="container">
            <div class="login-box">
                ...
                <div class="login-box-body">
                    ...
                    <form action="<?= asset('send-password-reset-link');?>" method="post">
                        <?= csrf_field();?>
                            @csrf
                        ...
                        <div class="forget-id">
                            <input type="submit" class="btn btn-primary btn-block btn-flat"  value="Send Reset Link">
                        </div>
                    </form>
                        </div>
