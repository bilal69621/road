<div class="sidebar-header">
    ...
    @if(isset($user) && $user->name != 'Guest User')
        <div class="user-name mobile-users">
    ...
    <ul class="roadside-manu">
        ...
        <li>
            <a href="#"  onclick="getLocationlat()">
                <img src="{{asset('public/assets/images/roadside-icon3.png')}}" class="mr-2"/>
                Gas Prices
            </a>
        </li>
        <li>
            <a href="{{route('subsecriptions')}}">
                <img src="{{asset('public/assets/images/roadside-icon4.png')}}" class="mr-2"/>
                Subscriptions
            </a>
        </li>
        @if(isset($user) && $user->name != 'Guest User')
